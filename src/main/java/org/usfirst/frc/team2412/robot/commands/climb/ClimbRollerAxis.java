...
public class ClimbRollerAxis extends CommandBase {
	...
	public void execute() {
		...
		// This way, it doesn't matter who starts the command as long as we're in the
		// right mode.
		if (RobotMap.CLIMB_MODE) {
			int forwardAxis = 1; // The joystick's y axis - moving the joystick forward will spin the roller
									// forward
